...
\item Once all the cosmic ray rejection is done (for science and reference images), run the subtraction. This will take a while. By default, {\tt --tempdate=19990101-20080101} (useful for SDSS), {\tt --temptel=IN}, and {\tt --fixpix=False}.

{\tt lscloop.py -n NAME -e TARGDATE-TARGDATE --normalize t -T IN [--tempdate TEMPDATE] [--temptel TEMPTEL] [--fixpix] -s diff}
